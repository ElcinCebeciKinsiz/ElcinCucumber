...
public class WebDriverStepDefinitions {
   ...
   // Faker faker=new Faker(); Line 53 ve 54 deki gibi faker class kullanarak user name ve pasword olusturmak istersek aktive hale getir burayi
    ...
    public void write_values_in_the_and_boxes(String userName, String password) {
      ...
      //webDriverPage.loginPageUserNameTextBox.sendKeys(faker.name().username());// fakerdan yapmak istersek

        webDriverPage.loginPageUserPasswordTextBox.sendKeys(password);
      //webDriverPage.loginPageUserPasswordTextBox.sendKeys(faker.internet().password());//Faker class dan yapmak istersek
    }
