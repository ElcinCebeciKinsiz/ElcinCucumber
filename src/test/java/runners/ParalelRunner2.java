...
public class ParalelRunner2 {
 ...
 BEAUTIFUL REPORT OLUSTURMA-->terminal-mvn clean verify-enter

  Ayni anda Birden fazla browser kullanarak farkli testleri run yapmak istiyorsak paralel testin kullaniyoruz.
  Bunu run yapmadan once pm.xml deki dependencylerde surefire ve failsafe altindaki kisimlarin ikisindede
   <include>**///runners/*ParalelRunner*.java</include> olan kisimda *ParalelRunner olarak update yaptik ve
 //<threadCount>2</threadCount> olan kisima 2yazdik 2 farkli browser acacagimiz icin ayni anda (sadece 1 browser acacak olsaydik 1
 // yapacaktik)
